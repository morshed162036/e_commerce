        ...
        <div class="containe">
            <div class="row py-5">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <p>Now shopping is easier, faster and always joyous. We help you make the best choice here.
                                kafela.com.bd is the biggest online market platform for Jhenaidah City offering
                                completely hassle-free shopping experience through secure and trusted gateways. We offer
                                you easy and reliable shopping with all your favorite brands, local brand in Jhenaidah
                                and more. Kafela provides products from all categories such as appliance, clothing,
                                cosmetics, electronics, footwear, jewellery, health & beauty, medicine, repair service,
                                car rent and still counting! Our collection combines the latest in fashion trends as
                                well as the all-time favorites. Our products collections are exclusively selected for
                                you. We have all that you need under one Platform.<br><br>In consistency with the vision
                                of Digital Bangladesh, Kafela provide service/product to the doorway over the Internet.
                                We constantly update with lot of new products, services and special offers.  </p>
                            <p><br></p>
                            <p><span style="color: rgb(5, 5, 5); font-family:  Segoe UI Historic, Segoe UI ,
                                    Helvetica, Arial, sans-serif; font-size: 14px;">Kafela gives you the best market
                                    experience possible so you can save your valuable time and money. You can pay using
                                    all types of payment gateways. If you want to return a product or service for any
                                    reason after receiving it, you will get an easy return system. So let's go to the
                                    Kafela.com.bd .</span><br><br><span style="color: rgb(5, 5, 5); font-family:  Segoe
                                    UI Historic, Segoe UI , Helvetica, Arial, sans-serif; font-size:
                                    14px;">Kafela.com.bd is a one of the largest online shop for Grocery, Fashion,
                                    Electronics, Health, Beauty & Much More..</span><br></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="customar-access row">
                    ...
                    <div class="flex flex-col justify-between">
                        <div>
                            <h2 class="text-4xl lg:text-5xl font-bold leading-tight"
                                style="font-weight: 800;margin-top: 20px;">Lets talk about everything!</h2>
                            <h2 class="text-4xl lg:text-5xl font-bold leading-tight nl"
                                style="font-weight: 800;margin-top: 20px;">With <a style="color:red"
                                    href="../login.html">Live Chat</a></h2>
                        </div>
                        <div class="mt-8 text-center m-hidec">
                            <svg class="w-full" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" id="ae37f038-3a9e-4b82-ad68-fc94ba16af2a"
                                data-name="Layer 1" viewBox="0 0 1096 574.74">
                                <defs>
                ...
                <div class="col-md-6">
                    <div class="card" style="padding: 20px;margin-top: 20px;">
                        <form action="https://laravel-ecommerce.xyz/contact/create" method="post" id="submit"
                            ...
                            <div class="form form2 row">
                                ...
                                <div class="form-group col-md-6">
                                    <input type="numver" name="phone" id="phone" class="form-control"
                                        placeholder="01*********">
                                ...
                                <div class="form-group col-md-12">
                                    <label style="font-size:15px">Upload Prescription or Bazar List</label>
                                ...
                                <button style="background: #108b3a;padding: 10px;border-radius: 10px;" type="submit"
                                    class="mt-1 btn btn-primary btn-block">Submit</button>
                            </div>
